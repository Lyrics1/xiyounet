...
function makeImg2() {
    ...
    img.drawString('helloworld', 20, 10, font.font8x16, 0x46b8da);
    img.drawString('helloworld', 20, 25, font.font12x24, 0xfcf8e3);
    img.drawString('helloworld', 20, 50, font.font16x32, 0xbce8f1);
    img.drawString('中国', 20, 85, cnfonts, 0xf2dede);
    return img;
}
...
function makeCapcha() {
    ...
    // img.drawRect(0, 0, img.w - 1, img.h - 1, z.rand(0, 0xCCFFFF));
    ...
    for (var i = 0; i < str.length; i++) {
        ...
        y = 8 + z.rand(-10, 10);
        img.drawChar(str[i], x, y, f, z.rand(0, 0x080808));
        x += f.w + z.rand(2, 8);
    }
    return img;
}